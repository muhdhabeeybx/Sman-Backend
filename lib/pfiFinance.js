...
/**
 * Orders that count as revenue. Pending has not been committed to and
 * Cancelled has been withdrawn; everything else is invoiced value.
 *
 * Note this is invoiced value on qualifying orders, not cash received.
 */
